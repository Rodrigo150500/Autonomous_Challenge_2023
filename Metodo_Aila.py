...
class Lane:
    ...
    def __init__(self, orig_frame):
        ...
        #Posição das Faixas da janela 1 e 2
        self.faixaXDirJ1 = None
        self.faixaXEsqJ1 = None
        self.faixaXDirJ2 = None
        self.faixaXEsqJ2 = None
        self.faixaYJ1 = None
        self.faixaYJ2 = None
    ...
    def get_lane_line_indices_sliding_windows(self, plot=False):
        ...
        for window in range(no_of_windows):
            ...
            if window == 0:
                self.faixaXDirJ1 = int(rightx_current)
                self.faixaXEsqJ1 = int(leftx_current)
                self.faixaYJ1 = int(win_y_low)
            if window == 5:
                self.faixaXDirJ2 = int(rightx_current)
                self.faixaXEsqJ2 = int(leftx_current)
                self.faixaYJ2 = int(win_y_high)
    ...
    def overlay_lane_lines(self, plot=False, plot_Superior = False):
        ...
        #Desenhando os pontos da faixa da esquerda
        cv2.circle(color_warp, (self.faixaXEsqJ1, self.faixaYJ1),2, (30,60,90),2 )
        cv2.circle(color_warp, (self.faixaXEsqJ1, self.faixaYJ2), 2, (65,96,130),2)
        cv2.circle(color_warp, (self.faixaXEsqJ2, self.faixaYJ2), 2, (135,200,35),2)

        cv2.circle(color_warp, (self.faixaXDirJ1, self.faixaYJ1), 2,(24,65,360,2))
        cv2.circle(color_warp, (self.faixaXDirJ1, self.faixaYJ2),2, (85,135,160),2)
        cv2.circle(color_warp, (self.faixaXDirJ2, self.faixaYJ2), 2, (25,36,55),2)
