...
filename = './Data/Video/Lane/Pista_05_Frame.mp4'
...
class Lane:
  ...
  def __init__(self, orig_frame):
    ...
    self.roi_points = np.float32([
      (0, 289),  # Top-left corner
      (0, 1078),  # Bottom-left corner
      (1918, 1078),  # Bottom-right corner
      (1918, 289)  # Top-right corner
    ])
  ...
  def get_line_markings(self, frame=None):
    ...
    self.lane_line_markings = cv2.bitwise_or(self.rs_binary, sxbinary.astype(
                              np.uint8))	
